...
export const AnthologiesSeed: AnthologySeedItem[] = [
  ...
  },
  {
    ...
    description: 'An indispensable field guide for the modern middle schooler. Inside: how to identify the five species of lunch table, the art of the strategic seat, and what to do when someone takes your fries. Written with extreme authority by students who have survived the cafeteria firsthand.',
  ...
  },
  {
    ...
    byline: 'Written by the Youth Literary Advisory Board',
    description: "What if the future had a forecast? Tomorrow's Almanac imagines daily life fifty years from now — weather reports for emotional climates, horoscopes calibrated to algorithms, and maps of cities that don't exist yet. A playful and searching collection from student writers.",
  ...
  },
  {
    ...
    description: 'Every student who applies to college must answer the same question: Who are you? Unlocked is a collection of college essays written by seniors who answered that question with radical honesty, surprising humor, and voices entirely their own.',
  ...
  },
  {
    ...
    description: 'Quick dispatches from the hallways, stairwells, and lunch lines of high school — tiny poems and observations scrawled between classes. Hallway Dispatches is a zine made fast and meant to be passed around.',
  ...
  },
  {
    ...
    description: "Boston's subway is full of strangers with stories. Field Notes From the T is a zine of flash nonfiction and sketches gathered by student writers riding the Green, Orange, and Red Lines — a document of a city always in motion.",
    genres: ['Nonfiction', 'Personal Narratives'],
  ...
  },
  {
    ...
    description: 'Writing this book was fun and helpful for us, as we are happy to read about other students at BINcA. Getting to know their experiences and walk a mile in their shoes makes us feel important, like we are part of something great.',
  ...
  },
  {
    ...
    status: AnthologyStatus.PUBLISHED,
    pubLevel: AnthologyPubLevel.CHAPBOOK,
    photoUrl: 'https://c4c-826boston-dev.s3.us-east-1.amazonaws.com/images/UtopiaDystopia.webp',
    sponsors: []
  },
  {
    title: "I'll Light Up My Own Sky",
    byline: 'Written by Boston Graduates, 2021-2025',
    description: 'A seemingly ordinary conversation, a personal failure, or a fleeting moment of doubt—when examined through the lens of reflection—can become the foundation of powerful storytelling.' +
    ...
    status: AnthologyStatus.PUBLISHED,
    pubLevel: AnthologyPubLevel.PERFECT_BOUND,
    photoUrl: 'https://c4c-826boston-dev.s3.us-east-1.amazonaws.com/images/Ill_Light_Up_My_Own_Sky.webp',
    sponsors: []
  },
  {
    ...
    status: AnthologyStatus.DRAFT,
    pubLevel: AnthologyPubLevel.SIGNATURE,
    photoUrl: 'https://c4c-826boston-dev.s3.us-east-1.amazonaws.com/images/people_like_us.webp',
    sponsors: []
  },
  {
    title: 'I Am Bravery Itself',
    byline: 'By the Dr. Albert D. Holland High School of Technology’s Exploration Academy',
    description: 'The middle school cohort at the Dr. Albert D. Holland High School of Technology’s is named the Exploration Academy. Aptly, in this collection, the Exploration Academy students take a deep dive into selfhood, using class projects ranging from portraits to poetry as inspiration.',
    ...
    status: AnthologyStatus.DRAFT,
    pubLevel: AnthologyPubLevel.CHAPBOOK,
    photoUrl: 'https://c4c-826boston-dev.s3.us-east-1.amazonaws.com/images/I_Am_Bravery_Itself.webp',
    sponsors: []
  },
  {
    title: 'In Everday Things',
    byline: 'Written by the Youth Literary Advisory Board at 826 Boston',
    description: '“The simplest things can be the greatest gifts; the smallest of moments can be the most memorable; the most consequential.”' +
    ...
    status: AnthologyStatus.DRAFT,
    pubLevel: AnthologyPubLevel.PERFECT_BOUND,
    photoUrl: 'https://c4c-826boston-dev.s3.us-east-1.amazonaws.com/images/in_everyday_things.webp',
    sponsors: []
  },
  {
    title: 'Nothing Suspicious Was Going On',
    byline: 'Written by the Youth Literary Advisory Board at 826 Boston',
    description: 'Nothing out of the ordinary here. No missing notebooks, or mysterious scratches, and definitely' +
    ...
    status: AnthologyStatus.IN_PRODUCTION,
    pubLevel: AnthologyPubLevel.CHAPBOOK,
    photoUrl: 'https://c4c-826boston-dev.s3.us-east-1.amazonaws.com/images/nothing_suspicious.webp',
    sponsors: []
  },
  {
    title: 'Who Are You?',
  ...
  },
  {
    ...
    byline: 'Written by Tenth Grade Students from Edward M. Kennedy Academy for Health Careers',
    description: 'Trilingual Poetry Written by Tenth Grade Students from Edward M. Kennedy Academy for Health Careers',
    ...
    status: AnthologyStatus.IN_REVISION,
    pubLevel: AnthologyPubLevel.CHAPBOOK,
    photoUrl: 'https://c4c-826boston-dev.s3.us-east-1.amazonaws.com/images/UsFromtheInsideandOut.webp',
    sponsors: []
  },
  {
    title: 'Rubix Literay Magazine #12 - Futures',
    byline: 'students from the John D. O’Bryant School of Mathematics and Science',
    description: 'Annual literary magazine publication, featuring poems, essays, and art around the theme "Futures”',
    genres: [
      'Nonfiiction',
      'Poetry',
      'Prose',
    ...
    status: AnthologyStatus.PUBLISHED,
    pubLevel: AnthologyPubLevel.ZINE,
    photoUrl: 'https://c4c-826boston-dev.s3.us-east-1.amazonaws.com/images/RUBIX.webp',
    sponsors: []
  },
];
